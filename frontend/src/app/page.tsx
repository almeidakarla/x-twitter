...
import { AnimatedXLogo } from '@/components/ui/animated-x-logo';
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-black">
      ...
      <div className="flex-1 flex flex-col justify-center px-6 sm:px-12 lg:px-16 py-12">
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-10 tracking-tight">
          Happening now
        </h1>
        ...
        <div className="max-w-sm space-y-6">
          ...
          <div className="space-y-3">
            <Button
              variant="outline"
              className="w-full bg-white text-black hover:bg-gray-100 font-medium py-2.5 rounded-full flex items-center justify-center gap-2"
          ...
          <Link href="/register">
            <Button className="w-full bg-blue-500 hover:bg-blue-600 text-white font-bold py-2.5 rounded-full">
              Create account
            </Button>
          </Link>
          ...
          <p className="text-xs text-gray-500 leading-relaxed">
            ...
            <span className="text-blue-500 hover:underline cursor-pointer">Privacy Policy</span>, including{' '}
            <span className="text-blue-500 hover:underline cursor-pointer">Cookie Use</span>.
          </p>

          {/* Sign in section */}
          <div className="pt-10">
            <p className="font-bold mb-4 text-lg">Already have an account?</p>
            <Link href="/login">
              <Button
                variant="outline"
                className="w-full border-gray-600 text-blue-500 hover:bg-blue-500/10 font-bold py-2.5 rounded-full"
              >
                Sign in
              </Button>
            </Link>
